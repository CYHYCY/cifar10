...
class Cifar(object):
    ...
    def get_args(self):
        ...
        parser.add_argument("--num_classes", type=int, default=10, help="number of batch size")
        ...
        parser.add_argument("--use_bias", type=bool, default=False, help="(default: True)")
        # loss
    ...
    def load_model(self, args):
        net = YHT_Net(use_bias=args.use_bias)
